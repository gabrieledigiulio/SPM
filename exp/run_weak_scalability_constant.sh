...
# ==============================================================================
# SPM "One-Shot" Project - Weak Scalability Experiment (Constant N)
# ==============================================================================
...
# Problem Parameters
# Manteniamo N costante per isolare la comunicazione di rete (payload fisso)
# Scaliamo NZ proporzionalmente per mantenere costante il lavoro su CPU
FIXED_N=1000000
BASE_NZ=31250000
MODE="irregular"
SEED=111
...
RESULT_DIR="results"
mkdir -p "$RESULT_DIR"
CSV_OUTPUT="${RESULT_DIR}/weak_scaling_constant_results.csv"
...
# ==========================================
echo "=========================================================="
echo " WEAK SCALABILITY EXPERIMENT (CONSTANT N) - $REPEATS REPEATS"
echo "=========================================================="
echo "  Fixed N:              $FIXED_N"
echo "  Base NZ per Node:     $BASE_NZ"
...
for nodes in "${NODES_LIST[@]}"; do
    # Calcolo della dimensione del problema (solo NZ scala)
    MATRIX_N=$FIXED_N
...
echo "=========================================================="
echo " Weak scalability (Constant N) sweep completed!"
